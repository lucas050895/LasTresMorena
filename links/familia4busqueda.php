...
<body>
    ...
    <?php
        ...
        <?php
            ...
            $sql_registe = mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM articulos WHERE familia = 4 AND descripcion LIKE '%$busqueda%'");
            ...
            $consulta = mysqli_query($conexion,"SELECT codigo, LEFT(descripcion,10) AS descripcion, precioventaunidades1 AS precio
                                                        FROM articulos
                                                        WHERE (familia = 4 AND descripcion LIKE '%$busqueda%') 
