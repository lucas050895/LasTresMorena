...
<body>
    ...
    <main>
        ...
        <?php
            $sql_registe = mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM articulos WHERE descripcion LIKE 'caña%'");
                ...
                <?php
                    while($fila=mysqli_fetch_assoc($consulta)){
                        ?>
                            <!-- CADA PRODUCTO -->
                            <li>
                                <img src="../resource/articulos/<?php echo $fila['codigo']; ?>.jpg" alt="">
